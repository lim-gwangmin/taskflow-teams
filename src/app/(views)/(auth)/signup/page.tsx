      ...
      <form className="space-y-4" onSubmit={handleSignupSubmit}>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input {...register("name")} id="name" type="text" placeholder="이름을 입력하세요" className="pl-10" />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            >
              {verifyCodeFlow.send && verifyCodeFlow.verify ? <CheckIcon size={25} color="green" /> : "인증 코드 발송"}
            </Button>
          </div>
